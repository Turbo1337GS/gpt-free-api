...
const cookies: Cookie[] = [
    { name: "supabase-auth-token", value: "VALUE COOKIE" }
];
export async function* openprompt(data: any) {//openprompt
    console.log(`provider: openprompt`)

    if (cookies === null) {
        console.log(`Need auth openprompt!`);
        return;
    }
    ...
    if (max_tokens) {
        console.log(`openprompt -> limit tokens not working`);
    }
    if (temperature) {
